<div class="contentglavn">
			...
			<div class="glavncont">
				...
				<div class="companies">
			<p class="pcomp" style=" opacity:0.6; font-style:open-sans; font-size:30px; font-weight: 700; line-height: 36px; color:#1f1f1f; border-bottom:2px solid #64d6eb; line-height: 20px; padding-bottom:20px;"> Список всех <small style="font-weight: 300; font-size:30px;"> домов с хорошим ремонтом: </small> 
				...
				<img style="height:25px; width;25px; margin-left:4px; padding-top:1px;" src="./img/remont.png">
			</p>


			<ul>
				<?php while($row=mysqli_fetch_assoc($hous2)) { ?>
